...
const ConnectModal = ({ openMintModal, handleOnClose }) => {
  return (
    <>
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl py-20 bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex gap-2 w-full text-center items-center justify-center">
                    ...
                    <button className="text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-xl text-sm px-4 py-2 hover:opacity-70">
                      <a href="/"> Go Home</a>
                    </button>
                    &nbsp;&nbsp;
                    {/* <button
